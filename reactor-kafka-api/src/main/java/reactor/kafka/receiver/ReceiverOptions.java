...
public class ReceiverOptions<K, V> {
    ...
    /**
     * Returns list of partition assignment listeners.
     */
    ...
    /**
     * Returns list of partition revocation listeners.
     * @return
     */
    ...
    /**
     * Returns the {@link KafkaConsumer#subscribe()}or {@link KafkaConsumer#assign()} operation
    ...
    /**
     * Returns the configured commit interval for {@link AckMode#AUTO_ACK} or {@value AckMode#MANUAL_ACK}.
     */
    ...
    /**
     * Configures commit interval for {@link AckMode#AUTO_ACK} or {@value AckMode#MANUAL_ACK}. At least
    ...
    /**
     * Returns the configured commit batch size for {@link AckMode#AUTO_ACK} or {@value AckMode#MANUAL_ACK}.
     */
    ...
    /**
     * Configures commit batch size for {@link AckMode#AUTO_ACK} or {@value AckMode#MANUAL_ACK}. At least
